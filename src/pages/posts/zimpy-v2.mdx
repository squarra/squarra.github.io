...
title: "zimpy version 2"
pubDate: 2024-03-07
description: "Some improvements to the zimpy project, which lets you host your own wikipedia"
---
import { Image } from 'astro:assets';
import rocket from '@assets/zimpy-v2/zimpy.png';
...
<Image src={rocket} alt="Zimpy Demo"/>
