...
title: "zimpy: Self hosted wikipedia"
pubDate: 2023-10-03
description: "Implementation of a ZIM file reader and simple python webserver, in order to host your own instance of wikipedia."
---

# zimpy: Personal Wikipedia Hosting

## [GitHub Repository](https://github.com/pierresquarra/zimpy)
