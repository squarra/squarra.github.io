---
title: 'Getting into Deep Learning'
...
In the past weeks, I got to dive into deep learning and found some very nice videos of people which deserve a lot of appreciation, for the value they provided to people like me, trying to get into this field. As per now, I only have videos listed, because that's mostly what I use to learn. The videos are not ranked or sorted in any kind of way.
